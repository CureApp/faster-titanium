    ...
    _createClass(FasterTitanium, [{
        ...
        value: function reflect() {
            ...
            options.names.forEach(function (name) {
                ...
                _this.reqAgent.clearCache(name);
            });
        }
        ...
        value: function reload() {
            ...
            setTimeout(function (x) {
                _this2.expectedReloads--;

                if (_this2.expectedReloads > 0 && !force) {
                    return ____('Reload suppressed because unresolved alloy compilations exists. Use web reload button to force reloading: ' + _this2.url);
                }
                ...
                try {
                    ...
                    ____('reload');
                    _this2.reqAgent.clearAllCaches();
                    _this2.reqAgent.require('app');
                }
            }, timer);
        }
    }]);
