...
var titleStyle = (_titleStyle = {
    ...
    fontSize: 16,
    background: '#ededed'
}, _defineProperty(_titleStyle, 'background', '-webkit-gradient(linear, left top, left bottom, from(#ededed), to(#ebebeb))'), _defineProperty(_titleStyle, 'background', '-moz-linear-gradient(top,  #ededed,  #ebebeb)'), _defineProperty(_titleStyle, 'borderRadius', 6), _defineProperty(_titleStyle, 'color', 'rgba(80, 80, 80, 1)'), _titleStyle);
