...
},{"../global-state":7,"../styles/modal":9,"./fa":3}],3:[function(require,module,exports){
"use strict";
...
},{"../global-state":7,"./fa":3}],5:[function(require,module,exports){
'use strict';
    ...
    _createClass(SelectionModal, [{
        ...
        value: function changeLoadingStyle() {
            ...
            fetch('/loading-style/' + val).then(function (res) {
                ...
                _this3.close();
                _globalState2.default.set('tableInfo', 'loading style', json.expression);
...
},{"../../common/preferences":1,"../global-state":7,"../styles/modal":9}],7:[function(require,module,exports){
"use strict";
