...
var FileServer = function (_EventEmitter) {
    ...
    _createClass(FileServer, [{
        ...
        value: function close() {
            ...
            ____('terminating...');
            return P(function (y) {
                return _this3.server.close(y) && y();
            }).then(function (x) {
                // TODO this.server.close() doesn't call the given callback.
                ____('closed');
            });
        }
        ...
        value: function responseResource(req, res) {
            ...
            var responder = new _resourceResponder2.default(this.projDir, url);
            if (!responder.exists) {
                responder = new _resourceResponder2.default(this.projDir, url, platform);
            }
