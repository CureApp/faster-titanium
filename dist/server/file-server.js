...
var FileServer = function (_EventEmitter) {
    ...
    _createClass(FileServer, [{
        ...
        key: 'clearAppJSCache',
        value: function clearAppJSCache() {
        ...
        key: 'webUI',
        value: function webUI(res) {

            var html = (0, _fs.readFileSync)(__dirname + '/../../web/index.html');
