 ...
 */
function showLogo() {
    console.log(_chalk2.default.red((0, _fs.readFileSync)(__dirname + '/../../doc/ft-txt-logo', 'utf8')));
...
function manipulateAppJS(data) {
    ...
    return generateNewAppJS(fPort, nPort, host).then(function (code) {
 ...
 * @private
 */
function generateNewAppJS(fPort, nPort, host) {

    var opts = JSON.stringify({ fPort: fPort, nPort: nPort, host: host });
